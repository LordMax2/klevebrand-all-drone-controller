...
PidConstants_t BasePidRepository::get() { return PidConstants_t(0, 0, 0, 0, 0, 0, 0, 0, 0); }

PidConstants_t BasePidRepository::get(int key) { return PidConstants_t(0, 0, 0, 0, 0, 0, 0, 0, 0); }
