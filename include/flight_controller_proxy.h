...
#define CONTROL_ACTION_COUNT            16

#define DO_NOTHING_CONTROL_ID           0
...
protected:
    ControlAction control_actions[CONTROL_ACTION_COUNT];

public:
    virtual ~FlightControllerProxy() = default;

    FlightControllerProxy();

    virtual void runAction(BaseDrone *drone, int id) const;
